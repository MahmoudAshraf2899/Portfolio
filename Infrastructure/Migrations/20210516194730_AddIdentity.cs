    ...
    public partial class AddIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Owner",
                keyColumn: "Id",
                keyValue: new Guid("5884f349-1050-40c8-b5f5-52f3f110453d"));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Owner",
                columns: new[] { "Id", "AddressId", "Avatar", "FullName", "Profile" },
                values: new object[] { new Guid("5884f349-1050-40c8-b5f5-52f3f110453d"), null, "avatar.jpg", "Mahmoud Ashraf Mohamed", "Full Stack Developer(.Net)" });
        }
    }
}
